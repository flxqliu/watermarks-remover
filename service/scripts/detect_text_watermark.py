...
# The deployed-class schemes under test in the v1 study (research/01 §2):
# KGW (three strengths via --config), SynthID-Text, EXP (Gumbel), Unigram,
# and SIR. All five ship configs in the MarkLLM checkout; SIR additionally
# needs its transform/embedding models downloaded per the MarkLLM README.
SCHEMES = {
    "kgw": "KGW",
    "synthid": "SynthID",
...
def _load_algorithm(
    ...
    kwargs so the v1 study's temperature factor (01 §2) is reproducible.
    """
