...
from audit_lib import aggregate, format_sarif, print_human_report, scan_file  # noqa: E402
...
def main() -> int:
    ...
    p.add_argument("--sarif", action="store_true", help="Emit an OASIS SARIF 2.1.0 report (alias for --format sarif)")
    p.add_argument(
        "-j",
        "--jobs",
        type=int,
